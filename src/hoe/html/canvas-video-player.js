...
CanvasVideoPlayer.prototype.setCanvasSize = function () {
    ...
    console.log('setCanvasSize', this.width, this.height);
};
...
CanvasVideoPlayer.prototype.drawFrame = function () {
    ...
    /*if (this.width > 0 && this.height > 0) {
        ...
        this.ctx.save();
        this.ctx.scale(ol.has.DEVICE_PIXEL_RATIO, ol.has.DEVICE_PIXEL_RATIO);

        var origo = this.map.getPixelFromCoordinate([0, 0]);
        var size = this.map.getPixelFromCoordinate([800, 450]);

        this.ctx.drawImage(0, 0, this.width, this.height);
        this.ctx.drawImage(this.video, origo[0], origo[1], size[0] - origo[0], size[1] - origo[1]);
        this.ctx.restore();
    ...
    /*if (this.drawRect) {
        ...
        var x = this.drawRect[0];
        var y = this.drawRect[1];
        var w = this.drawRect[2];
        var h = this.drawRect[3];
    ...
    //console.log('canvasVideo',this.map.getPixelFromCoordinate([0, 0]));
};