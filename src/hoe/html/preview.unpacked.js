...
(function (g, h, k) {
    var e = {
        ...
        on_ZOOM_PAN_UPDATE: function(){
            ...
            var vals = $('#yourImageID').css('transform').replace(/\(|\)|scale/g,'').split(',')
            var scale = parseFloat(vals[3]);
            var x = parseFloat(vals[4]);
            var y = parseFloat(vals[5]);

            console.log(x+' '+y+' '+scale);
            //$('#tile1').css('top',$('#yourImageID').position().top);
            //$('#tile1').css('left',$('#yourImageID').position().left);
            //$('#tile1').css('transform', 'translate(' + 0 + 'px,' + 0 + 'px) '+'scale(' + (scale) + ')');
            //$('#tile1').css('transform', 'translate(' + x + 'px,' + y + 'px)');
        },
    ...
    j.prototype = {
        ...
        setContainer: function () {
            ...
            if (m.container == "" && m.image_url == "") {
                r = m.$image.wrap('<div id="divtoextend" class="noSel smooth_zoom_preloader">					</div>').parent()
            } else {
                if (m.image_url == "") {
                    r = g("#" + m.container)
                } else {
            ...
            m.$hitArea = g('<div id="hitarea" style="position: absolute; z-index: ' + (a ? 2 : 1) + '; top: 0px; left: 0px; width: 100%; height: 100%;" ></div>').appendTo(r);
            ...
            if (s > 0) {
                o[0] = g('<div id="container1" style="position: absolute;	width: ' + s + "px; height: " + n + "px;	top: 0px; left: 0px; z-index: 3; background-color: " + m.bord_color + ';"></div>').css("opacity", m.bord_alpha);
                o[1] = g('<div id="container2" style="position: absolute;	width: ' + s + "px; height: " + n + "px;	top: 0px; left: " + (t - s) + "px; z-index: 4; background-color: " + m.bord_color + ';"></div>').css("opacity", m.bord_alpha);
                o[2] = g('<div id="container3" style="position: absolute;	width: ' + (t - (s * 2)) + "px; height: " + s + "px; top: 0px; left: " + s + "px; z-index: 5; background-color: " + m.bord_color + '; line-height: 1px;"></div>').css("opacity", m.bord_alpha);
                o[3] = g('<div id="container4" style="position: absolute;	width: ' + (t - (s * 2)) + "px; height: " + s + "px; top: " + (n - s) + "px; left: " + s + "px; z-index: 6; background-color: " + m.bord_color + '; line-height: 1px;"></div>').css("opacity", m.bord_alpha);
